...
function getCategoryEmbed(client, index, categoryNames){
    ...
    .setDescription('[] and <> are not a part of the command\'s, <> means the argument is required for the command to work and [] means the argument is optional for the command.')
    .setColor(client.config.color)
    .setThumbnail(client.user.displayAvatarURL())
